    ...
    const tech = [
      ...
      return (
        <section id="skill">
            ...
            <div className="m-auto bg-[#353535] flex justify-center items-center py-10 gap-10 md:flex-col md:p-5">
                ...
                <div className="flex flex-wrap gap-3 basis-[30%] md:justify-center">
