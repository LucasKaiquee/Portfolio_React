    ...
    return (
        <header className="bg-background-main w-full h-[100vh] bg-cover bg-center flex flex-col justify-center">
            <div className="w-[80%] m-auto md:text-center">
                ...
                <p className="text-xl w-[550px] md:m-auto sm:text-sm sm:w-full sm:px-2">Atualmente estou cursando Sistemas para Internet e buscando uma oportunidade de estágio na aéra.</p>
