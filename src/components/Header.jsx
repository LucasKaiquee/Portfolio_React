    ...
    return (
        <header className="bg-background-main w-full h-[100vh] bg-cover bg-center flex flex-col justify-center">
            <div className="ml-[50px] sm:m-0 sm:text-center">
                ...
                <h1 className="text-7xl font-bold sm:text-2xl sm:mb-3">Desenvolvedor <span className="text-[#00B3FF]">Front - End</span></h1>
                <p className="text-xl w-[550px] sm:text-sm sm:w-full sm:px-2">Atualmente estou cursando Sistemas para Internet e estou buscando uma oportunidade de estágio na aéra.</p>
