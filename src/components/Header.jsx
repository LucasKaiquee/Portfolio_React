...
import curriculo from '/Currículo_Lucas_Kaique_estágio_DEV.pdf'
    ...
    return (
        <header className="bg-background-main w-full h-[100vh] bg-cover bg-center flex flex-col justify-center">
            <div className="w-[80%] m-auto md:text-center">
                ...
                <h3 className="text-3xl font-bold mb-5 sm:text-2xl sm:mb-3">Desenvolvedor <span className="text-[#00B3FF]">Web</span></h3>
                <p className="text-xl w-[550px] md:m-auto sm:text-sm sm:w-full sm:px-2">Desenvolvedor web apaixonado com mais de um ano de experiência em projetos e estágio.</p>
