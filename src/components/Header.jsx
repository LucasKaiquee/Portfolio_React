...
const Header = () => {
    ...
    return (
        <header className="bg-background-main w-full h-[100vh] bg-cover bg-center flex flex-col justify-center">
            <div className="ml-[50px] md:m-0 md:text-center">
                <h3 className="text-5xl font-bold mb-5 sm:text-xl sm:mb-2">Olá, Sou o Lucas</h3>
                <h1 className="text-7xl font-bold sm:text-2xl sm:mb-3 md:text-5xl">Desenvolvedor <span className="text-[#00B3FF]">Front - End</span></h1>
                <p className="text-xl w-[550px] sm:text-sm sm:w-full sm:px-2 md:text-center md:m-auto">Atualmente estou cursando Sistemas para Internet e estou buscando uma oportunidade de estágio na aéra.</p>
